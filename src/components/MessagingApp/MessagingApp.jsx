...
const MessagingApp = () => {
    ...
    const [arrayOfUsers, setArrayOfUsers] = useState(undefined);
    ...
    return (
        <div>
            <Card
                className=" rounded-4 border-1  border-light-subtle my-3 mx-auto"
                    ...
                    <div className="">
                        ...
                        <div className="p-3" style={{}}>
                            ...
                            {messages?.toReversed().map((mes) => {
                                ...
                                const thisRecipient = arrayOfUsers.filter(
                                    (user) => user?._id === mess.recipient,
                                );

            ...
            <Container
                ...
                <div className="d-flex align-items-center flex-grow-1 flex-md-grow-0">
                    ...
                    <Form className="d-md-block">
                        <InputGroup
                            size="sm"
                            className="rounded-5 p-1 border border-black bg-light">
                ...
                <Nav className="flex-row align-items-center ms-auto">
                    <Nav.Link
                        ...
                        <span className="d-none d-md-block spanUnderIcon">
                            Home
                        </span>
                    </Nav.Link>
                    ...
                    <Nav.Link
                        href="#"
                        className="d-flex flex-column align-items-center px-2 px-md-3 text-secondary text-hover">
                    ...
                    <Nav.Link
                        href="#"
                        className="d-none d-md-flex flex-column align-items-center px-3 text-secondary">

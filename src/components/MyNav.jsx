        ...
        <Navbar className="sticky-top bg-white border-bottom py-0" id="nav">
            <Container
                ...
                <Nav className="flex-row align-items-center ms-auto">
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `nav-link d-flex flex-column align-items-center px-2 px-md-3 text-hover ${
                                isActive
                                    ? "text-dark border-bottom border-dark border-2 border-md-0"
                                    : "text-secondary"
                            }`
                        }>
                    ...
                    <NavLink
                        as="div"
                        className="nav-link d-flex flex-column align-items-center px-2 px-md-3 text-hover text-secondary">
